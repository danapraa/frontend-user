...
import { Award, Building, Calendar, Upload, FileText } from "lucide-react";
...
const STORAGE_KEY = "training_form_data";
...
const TrainingForm = () => {
  ...
  const loadFromLocalStorage = (): any => {
    try {
      ...
      if (savedData) {
        ...
        // console.log("Training data loaded from localStorage:", parsedData);
        return parsedData;
      }
    } catch (error) {
  ...
  const saveToLocalStorage = (data: any) => {
    try {
      ...
      // console.log("Training data saved to localStorage:", data);
    } catch (error) {
  ...
  const clearLocalStorage = () => {
    try {
      ...
      console.error("Error clearing training localStorage:", error);
    }
  };
  ...
  const validateForm = (): FormErrors => {
    ...
    if (!formData.name.trim()) {
      newErrors.name = "Nama pelatihan wajib diisi";
    }
    ...
    if (!formData.deskripsi.trim()) {
      newErrors.deskripsi = "Deskripsi pelatihan wajib diisi";
    } else if (formData.deskripsi.trim().length < 10) {
      newErrors.deskripsi = "Deskripsi pelatihan minimal 10 karakter";
    }

    if (!formData.sertifikat_file && !formData.sertifikat_base64) {
      newErrors.sertifikat_file = "File sertifikat pelatihan wajib diupload";
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccessMessage("Data pelatihan berhasil disimpan");
    } catch (error: any) {
      console.error("Error saving training data to localStorage:", error);
      setErrors({
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="Contoh: Digital Marketing, Web Development"
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Contoh: Google, Microsoft, Universitas ABC"
                  className={`w-full px-4 py-3 rounded-lg border ${
            ...
            <div className="space-y-2 mt-6">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                placeholder="Jelaskan materi yang dipelajari, skill yang didapat, atau informasi tambahan tentang pelatihan ini..."
                rows={4}
                className={`w-full px-4 py-3 rounded-lg border ${
                  errors.deskripsi
                    ? "border-red-500"
